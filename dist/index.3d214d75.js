...
})({"7N5V6":[function(require,module,exports) {
...
store.dispatch((0, _cartReducer.addCartItem)(7, 2));
store.dispatch((0, _cartReducer.removeCartItem)(1, 1));
store.dispatch((0, _cartReducer.increaseQty)(7));
store.dispatch((0, _cartReducer.decreaseQty)(7));
store.dispatch((0, _wishlistReducer.addToWishlist)(13));
store.dispatch((0, _wishlistReducer.addToWishlist)(19));
store.dispatch((0, _wishlistReducer.addToWishlist)(4));
store.dispatch((0, _wishlistReducer.removeFromWishlist)(4));
store.dispatch((0, _cartReducer.decreaseQty)(7));
store.dispatch((0, _cartReducer.decreaseQty)(7));

},{"redux":"anWnS","./productReducer":"g20cL","./cartReducer":"96Hwp","./wishlistReducer":"77x5m","@parcel/transformer-js/src/esmodule-helpers.js":"2SxZ5"}],"anWnS":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"2SxZ5"}],"2SxZ5":[function(require,module,exports) {
...
},{}],"g20cL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./productsList":"e6lBk","@parcel/transformer-js/src/esmodule-helpers.js":"2SxZ5"}],"e6lBk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"2SxZ5"}],"96Hwp":[function(require,module,exports) {
...
parcelHelpers.export(exports, "increaseQty", ()=>increaseQty);
parcelHelpers.export(exports, "decreaseQty", ()=>decreaseQty);
...
function removeCartItem(productId, qty) {
    return {
        type: REMOVE_ITEM,
        payload: {
            productId,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"2SxZ5"}],"77x5m":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"2SxZ5"}]},["7N5V6","bB7Pu"], "bB7Pu", "parcelRequirefc40")
